...
namespace assignment_data
{
constexpr Matrixi<20, 20> distances({
    {
...
static_assert(assignment_data::flows.is_symmetric());
static_assert(assignment_data::distances.is_symmetric());

constexpr size_t optimal_cost = 2570;
}  // namespace assignment_data
